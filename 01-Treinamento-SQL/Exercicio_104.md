...
--Opção 1:
select count(c.id_cliente) as "total de contas sem compras há +90d"
from t_cliente c
...
- [x] Usa maior data da base como referência
- [x] Calcula diferença de 90 dias corretamente
- [x] Identifica última compra por cliente
